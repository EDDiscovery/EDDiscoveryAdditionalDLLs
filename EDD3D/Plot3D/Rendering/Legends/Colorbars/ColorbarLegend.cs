...
using EDD3D.Colors;
using EDD3D.Plot2D.Primitive;
using EDD3D.Plot3D.Primitives;
using EDD3D.Plot3D.Primitives.Axes.Layout;
using EDD3D.Plot3D.Primitives.Axes.Layout.Providers;
using EDD3D.Plot3D.Primitives.Axes.Layout.Renderers;
using EDD3D.Plot3D.Rendering.Legends;

namespace EDD3D.Plot3D.Rendering.Legends.Colorbars
{
