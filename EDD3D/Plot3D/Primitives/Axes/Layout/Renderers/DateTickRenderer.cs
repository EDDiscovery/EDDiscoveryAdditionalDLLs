...
namespace EDD3D.Plot3D.Primitives.Axes.Layout.Renderers
{
	...
	public class DateTickRenderer : ITickRenderer
	{
		...
		{
			DateTime ldate = EDD3D.Maths.Utils.num2date(Convert.ToInt64(value));
			return EDD3D.Maths.Utils.dat2str(ldate, _format);
		}
